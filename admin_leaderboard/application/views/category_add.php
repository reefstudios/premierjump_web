...
<?php 
    echo form_open_multipart("question/category_create",'class="form-horizontal"');
//    
...
?>
      ...
      <div class="control-group">
            <label class="control-label" for="category_name">Category String</label>
            <div class="controls">
        ...
        <div class="form-actions">
              <?php echo form_submit('submit', "Create Category",' class="btn blue"');?>
          </div>
