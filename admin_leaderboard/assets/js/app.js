...
//            App.scrollTo();
            ...
            call_api("getUsagesByDate",{start:start, end:end}, App.plotWithOptions3 );
            /*
            setTimeout(function () {
                App.unblockUI(jQuery("#dashboard"));
                $.gritter.add({
        ...
        $('#dashboard-report-range span').html(g_range_time.start.toString('MMMM d, yyyy') + ' - ' + g_range_time.end.toString('MMMM d, yyyy'));
